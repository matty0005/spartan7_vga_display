...
#
# Generated by Vivado on Wed Jul 20 14:58:16 +1000 2022
...
# Script info
echo -e "clk_65mhz.sh - Script generated by export_simulation (Vivado v2022.1.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot clk_65mhz xil_defaultlib.clk_65mhz xil_defaultlib.glbl -log elaborate.log
}
